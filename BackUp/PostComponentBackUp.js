...
export class PostComponentBackUp extends Component {
    state = {
        posts: []
    };
    render() {
        getArticlesFromApi().then((posts) => {
    ...
    return (
         <ScrollView style={styles.scrollView}> 
             <View style={styles.post}>  
                ...
                <Text style={styles.bar}>___________________________________________</Text>
                <Text style={styles.aboutWriter}> About the Writer </Text>
                ...
                <Text style={styles.sectionArticleTitle}> {recentArticle1Title}  </Text>
                <Text style={styles.sectionAuthor}> By {recentArticle1Author}  </Text>
                <Text style={styles.sectionDate}> {recentArticle1Date} </Text>
                <Text style={styles.sectionRenderedText}> {recentArticle1RenderedText} </Text>
                <Image style={styles.sectionImage} source={require("./assets/Trinity.jpg")}/>
                <Text style={styles.sectionArticleTitle}> {recentArticle2Title}  </Text>
                <Text style={styles.sectionAuthor}> By {recentArticle2Author}  </Text>
                <Text style={styles.sectionDate}> {recentArticle2Date} </Text>
                <Text style={styles.sectionRenderedText}> {recentArticle2RenderedText} </Text>
                <Image style={styles.sectionImage} source={require("./assets/Trinity.jpg")}/>
                <Text style={styles.sectionArticleTitle}> {recentArticle3Title}  </Text>
                <Text style={styles.sectionAuthor}> By {recentArticle3Author}  </Text>
                <Text style={styles.sectionDate}> {recentArticle3Date} </Text>
                <Text style={styles.sectionRenderedText}> {recentArticle3RenderedText} </Text>
                <Text style={styles.sectionBulletTitle}> • {recentArticle4Title}: {recentArticle4Date}</Text>
                <Text style={styles.sectionBulletTitle}> • {recentArticle5Title}: {recentArticle5Date}</Text>
                <Text style={styles.sectionBulletTitle}> • {recentArticle6Title}: {recentArticle6Date}</Text>
